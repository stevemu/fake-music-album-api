...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCommentBox = __webpack_require__(176);
	...
	var App = (function () {
		...
		_createClass(App, [{
			...
			value: function render(domElement) {
				var reactElement = _reactAddons2['default'].createElement(_componentsCommentBox2['default'], { url: '/api/comments' });

				// render to DOM
				if (domElement) {
					_reactAddons2['default'].render(reactElement, domElement);
					return;
				}
			}
		}, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _react = __webpack_require__(242);
