...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHello = __webpack_require__(243);
	...
	var App = (function () {
		...
		_createClass(App, [{
			...
			value: function render(domElement) {
				var reactElement = _react2['default'].createElement(_componentsHello2['default'], null);

				// render to DOM
				if (domElement) {
					_react2['default'].render(reactElement, domElement);
					return;
				}
			}
		}, {
